...
/**
 * Legacy franchises, now a tab inside the Partner Program desk.
 *
 * Franchises predate the Partner Program and work differently: a franchise takes
 * 5% of the GROSS FARE (capped at the commission) on rides by drivers assigned
 * to it, and it is created by an admin rather than applied for. Partners take a
 * percentage of the COMMISSION and recruit themselves with a referral code.
 *
 * The two coexist deliberately — existing franchise contracts are still owed
 * what they were promised, and `trips/completeTrip` pays the franchise first,
 * then the fleets. Do not merge the two models without a migration.
 */
...
export function FranchisesPanel() {
