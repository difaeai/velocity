...
const createTripSchema = z.object({
  ...
  operatorName:          z.string().min(1).max(64).default('Velocity Rides'),
...
export const seedIntercityTrips = onCall(async (req) => {
  ...
  const SEED_ROUTES: SeedTrip[] = [
    ...
    { fromCityId:'lahore', fromCityName:'Lahore', toCityId:'islamabad', toCityName:'Islamabad', dayOffset:0, hour:6,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:1100, durationHours:5,  pickupPoint:'Velocity Rides Terminal, Lahore (Gulberg)',    dropoffPoint:'Velocity Rides Terminal, Islamabad (F-10)' },
    { fromCityId:'lahore', fromCityName:'Lahore', toCityId:'islamabad', toCityName:'Islamabad', dayOffset:0, hour:9,  min:0,  vehicleType:'business_ac',  totalSeats:14, farePerSeat:1800, durationHours:5,  pickupPoint:'Velocity Rides Terminal, Lahore (Gulberg)',    dropoffPoint:'Velocity Rides Terminal, Islamabad (F-10)' },
    { fromCityId:'lahore', fromCityName:'Lahore', toCityId:'islamabad', toCityName:'Islamabad', dayOffset:0, hour:14, min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:1100, durationHours:5,  pickupPoint:'Velocity Rides Terminal, Lahore (Gulberg)',    dropoffPoint:'Velocity Rides Terminal, Islamabad (F-10)' },
    { fromCityId:'lahore', fromCityName:'Lahore', toCityId:'islamabad', toCityName:'Islamabad', dayOffset:1, hour:7,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:1100, durationHours:5,  pickupPoint:'Velocity Rides Terminal, Lahore (Gulberg)',    dropoffPoint:'Velocity Rides Terminal, Islamabad (F-10)' },
    ...
    { fromCityId:'islamabad', fromCityName:'Islamabad', toCityId:'lahore', toCityName:'Lahore', dayOffset:0, hour:7,  min:30, vehicleType:'standard_ac', totalSeats:28, farePerSeat:1100, durationHours:5,  pickupPoint:'Velocity Rides Terminal, Islamabad (F-10)',    dropoffPoint:'Velocity Rides Terminal, Lahore (Gulberg)' },
    { fromCityId:'islamabad', fromCityName:'Islamabad', toCityId:'lahore', toCityName:'Lahore', dayOffset:0, hour:13, min:0,  vehicleType:'business_ac',  totalSeats:14, farePerSeat:1800, durationHours:5,  pickupPoint:'Velocity Rides Terminal, Islamabad (F-10)',    dropoffPoint:'Velocity Rides Terminal, Lahore (Gulberg)' },
    { fromCityId:'islamabad', fromCityName:'Islamabad', toCityId:'lahore', toCityName:'Lahore', dayOffset:1, hour:8,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:1100, durationHours:5,  pickupPoint:'Velocity Rides Terminal, Islamabad (F-10)',    dropoffPoint:'Velocity Rides Terminal, Lahore (Gulberg)' },
    // Karachi ↔ Lahore
    { fromCityId:'karachi', fromCityName:'Karachi', toCityId:'lahore', toCityName:'Lahore', dayOffset:0, hour:18, min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:3800, durationHours:18, pickupPoint:'Velocity Rides Terminal, Karachi (Gulshan)',   dropoffPoint:'Velocity Rides Terminal, Lahore (Gulberg)' },
    { fromCityId:'karachi', fromCityName:'Karachi', toCityId:'lahore', toCityName:'Lahore', dayOffset:1, hour:20, min:0,  vehicleType:'business_ac',  totalSeats:14, farePerSeat:5800, durationHours:18, pickupPoint:'Velocity Rides Terminal, Karachi (Gulshan)',   dropoffPoint:'Velocity Rides Terminal, Lahore (Gulberg)' },
    { fromCityId:'lahore',  fromCityName:'Lahore',  toCityId:'karachi', toCityName:'Karachi', dayOffset:0, hour:19, min:0, vehicleType:'standard_ac', totalSeats:28, farePerSeat:3800, durationHours:18, pickupPoint:'Velocity Rides Terminal, Lahore (Gulberg)',    dropoffPoint:'Velocity Rides Terminal, Karachi (Gulshan)' },
    // Islamabad ↔ Peshawar
    { fromCityId:'islamabad', fromCityName:'Islamabad', toCityId:'peshawar', toCityName:'Peshawar', dayOffset:0, hour:8,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:680, durationHours:2.5, pickupPoint:'Velocity Rides Terminal, Islamabad (F-10)', dropoffPoint:'Peshawar Bus Terminal (GT Road)' },
    { fromCityId:'islamabad', fromCityName:'Islamabad', toCityId:'peshawar', toCityName:'Peshawar', dayOffset:0, hour:14, min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:680, durationHours:2.5, pickupPoint:'Velocity Rides Terminal, Islamabad (F-10)', dropoffPoint:'Peshawar Bus Terminal (GT Road)' },
    { fromCityId:'peshawar',  fromCityName:'Peshawar',  toCityId:'islamabad', toCityName:'Islamabad', dayOffset:0, hour:7, min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:680, durationHours:2.5, pickupPoint:'Peshawar Bus Terminal (GT Road)',    dropoffPoint:'Velocity Rides Terminal, Islamabad (F-10)' },
    ...
    { fromCityId:'islamabad', fromCityName:'Islamabad', toCityId:'abbottabad', toCityName:'Abbottabad', dayOffset:0, hour:9, min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:580, durationHours:2, pickupPoint:'Velocity Rides Terminal, Islamabad (F-10)', dropoffPoint:'Abbottabad Bus Stand' },
    { fromCityId:'abbottabad',fromCityName:'Abbottabad',toCityId:'islamabad', toCityName:'Islamabad',   dayOffset:0, hour:8, min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:580, durationHours:2, pickupPoint:'Abbottabad Bus Stand',                 dropoffPoint:'Velocity Rides Terminal, Islamabad (F-10)' },
    ...
    // Karachi ↔ Hyderabad
    { fromCityId:'karachi',    fromCityName:'Karachi',    toCityId:'hyderabad', toCityName:'Hyderabad',     dayOffset:0, hour:8,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:580, durationHours:2, pickupPoint:'Velocity Rides Terminal, Karachi (Gulshan)', dropoffPoint:'Hyderabad Bus Terminal' },
    { fromCityId:'karachi',    fromCityName:'Karachi',    toCityId:'hyderabad', toCityName:'Hyderabad',     dayOffset:0, hour:14, min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:580, durationHours:2, pickupPoint:'Velocity Rides Terminal, Karachi (Gulshan)', dropoffPoint:'Hyderabad Bus Terminal' },
    { fromCityId:'hyderabad',  fromCityName:'Hyderabad',  toCityId:'karachi', toCityName:'Karachi',         dayOffset:0, hour:9,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:580, durationHours:2, pickupPoint:'Hyderabad Bus Terminal',                dropoffPoint:'Velocity Rides Terminal, Karachi (Gulshan)' },
    // Lahore ↔ Multan
    { fromCityId:'lahore',     fromCityName:'Lahore',     toCityId:'multan', toCityName:'Multan',           dayOffset:0, hour:7,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:950,  durationHours:5,  pickupPoint:'Velocity Rides Terminal, Lahore (Gulberg)', dropoffPoint:'Multan Bus Terminal' },
    { fromCityId:'multan',     fromCityName:'Multan',     toCityId:'lahore', toCityName:'Lahore',           dayOffset:0, hour:8,  min:0,  vehicleType:'standard_ac', totalSeats:28, farePerSeat:950,  durationHours:5,  pickupPoint:'Multan Bus Terminal',                  dropoffPoint:'Velocity Rides Terminal, Lahore (Gulberg)' },
    // Islamabad ↔ Naran
