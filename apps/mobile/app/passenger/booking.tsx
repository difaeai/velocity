...
const styles = StyleSheet.create({
  ...
  poolTierRow: {
    ...
    paddingVertical: 11,
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(204,255,0,0.30)',
    gap: 8,
  },
  poolTierRowSelected: { backgroundColor: 'rgba(204,255,0,0.12)' },
  ...
  orDividerLine: { flex: 1, height: 1, backgroundColor: 'rgba(255,255,255,0.12)' },
  ...
  optionToggle:        {
    ...
    borderColor: 'rgba(255,255,255,0.12)', paddingHorizontal: 10, paddingVertical: 8,
  },
