...
/**
 * Driver phone login. New drivers verify their number by OTP and are then sent
 * to the driver registration checklist to complete their application.
 */
...
const styles = StyleSheet.create({
  ...
  phoneInput: {
    flex: 1, height: 54, paddingHorizontal: 16, borderRadius: 14,
    borderWidth: 1.5, borderColor: colors.border, backgroundColor: colors.surface,
  ...
  bannerWaiting: { backgroundColor: colors.surface, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.border, gap: 4 },
  bannerOk:      { backgroundColor: colors.glassLime, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.glassLimeBorder, gap: 4 },
  bannerText:    { color: colors.text, fontSize: 14, fontWeight: '700' },
  bannerSub:     { color: colors.muted, fontSize: 12 },

  otpInput: {
    height: 60, borderRadius: 14, borderWidth: 1.5, borderColor: colors.border,
    backgroundColor: colors.surface, color: colors.text, fontSize: 26,
