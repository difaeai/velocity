...
const styles = themed(() => StyleSheet.create({
  ...
  privacyCard:    { backgroundColor: colors.glassLime, borderRadius: 14, borderWidth: 1, borderColor: `${colors.primary}30`, padding: 14, marginBottom: 14 },
  ...
  dayBtnActive:   { borderColor: colors.primary, backgroundColor: colors.glassLime },
