...
const styles = themed(() => StyleSheet.create({
  ...
  payBtnActive: { borderColor: colors.primary, backgroundColor: colors.glassLime },
  ...
  // Stage 2 map
  mapBg: { ...StyleSheet.absoluteFill, backgroundColor: colors.background },
  road: { position: 'absolute', left: -50, width: '120%', height: 28, backgroundColor: '#1e2020', borderRadius: 4 },
  mapPin: { position: 'absolute', width: 34, height: 34, borderRadius: 17, backgroundColor: colors.glassChip, alignItems: 'center', justifyContent: 'center' },
  ...
  backBtn:   { width: 40, height: 40, borderRadius: 20, backgroundColor: colors.glassChip, alignItems: 'center', justifyContent: 'center' },
  backTxt:   { fontSize: 20, color: colors.text },
  floatRoute: { flex: 1, backgroundColor: colors.glassChip, borderRadius: 14, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 14, paddingVertical: 8, gap: 4 },
  ...
  floatBadge: { backgroundColor: colors.glassChip, borderRadius: 10, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 10, paddingVertical: 6, alignItems: 'center' },
  ...
  tripCardActive: { borderColor: colors.primary, backgroundColor: colors.glassLime },
...
const modal = themed(() => StyleSheet.create({
  ...
  popularChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: colors.primary + '60', backgroundColor: colors.glassLime },
