...
const styles = StyleSheet.create({
  ...
  privacyBanner:   { backgroundColor: colors.glassLime, paddingHorizontal: 16, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: `${colors.primary}20` },
  ...
  countBadge:      { alignItems: 'center', backgroundColor: colors.glassLime, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6 },
