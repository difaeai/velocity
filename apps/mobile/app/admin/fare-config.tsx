...
const styles = themed(() => StyleSheet.create({
  ...
  segmentRow: { flexDirection: 'row', margin: 16, backgroundColor: colors.surface, borderRadius: 12, padding: 4 },
  ...
  rateBtn:     { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.glassStrong, alignItems: 'center', justifyContent: 'center' },
