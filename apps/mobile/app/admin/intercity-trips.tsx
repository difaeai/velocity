...
const styles = themed(() => StyleSheet.create({
  ...
  actionBtn: { borderRadius: 8, borderWidth: 1, borderColor: colors.primary + '60', backgroundColor: colors.glassLime, paddingHorizontal: 12, paddingVertical: 6 },
  ...
  vtChipActive: { borderColor: colors.primary, backgroundColor: colors.glassLime },
