 ...
 */
/** Exported so tests assert the ladder's shape rather than copies of its numbers. */
export const COOLDOWN_LADDER_S = [0, 59, 90, 120, 180, 240, 300];
...
export const LONGEST_COOLDOWN_S = Math.max(...COOLDOWN_LADDER_S);
